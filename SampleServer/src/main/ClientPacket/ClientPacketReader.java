...
abstract public class ClientPacketReader implements AutoCloseable {
	private int index = 1;

	protected byte[] data = null;

	protected final ClientThread client;

	protected ClientPacketReader(final byte[] data, final ClientThread client) {
		this.data = data;
		this.client = client;
	}
